...
def select_network(_iface, _id):
	...
	if target_index != present_index:
		_set_parameter(_iface, ids[present_index], "priority", int(priorities[target_index]))
		_set_parameter(_iface, ids[target_index], "priority", int(priorities[present_index]))
